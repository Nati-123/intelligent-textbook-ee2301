...
**Answer:** $2A3_{16} = 675_{10} = 10200_{5} = 1243_{8}$
...
**Answer:** $-95_{10} = 10100001_2$, $-48_{10} = 11010000_2$
...
**Answer:** Value: The sign bit is 1, so the number is negative. Taking the two's complement of $110100.11010$:
...
**Answer:** Digit-by-digit BCD addition:
