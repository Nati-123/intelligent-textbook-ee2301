...
- Chapter 5: Passive Components: Resistors, Capacitors, and Inductors (from circuits textbook)
- Chapter 6: Transient Analysis of RC and RL Circuits (from circuits textbook)
