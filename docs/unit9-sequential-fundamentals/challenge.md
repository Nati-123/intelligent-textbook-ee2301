...
**Answer:** From the state table, next state = present state + 1 when $X=0$, and present state + 2 when $X=1$ (modulo 4).
...
**Answer:** **(a) Setup time constraint:**
...
**Answer:** **Master-slave (level-sensitive master):**
