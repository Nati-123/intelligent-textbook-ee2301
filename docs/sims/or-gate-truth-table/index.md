...
[Run the OR Gate with Truth Table Fullscreen](./main.html){ .md-button .md-button--primary }
...
```html
<iframe src="https://Nati-123.github.io/intelligent-textbook-ee2301/sims/or-gate-truth-table/main.html" height="480px" scrolling="no" width="100%"></iframe>
```
