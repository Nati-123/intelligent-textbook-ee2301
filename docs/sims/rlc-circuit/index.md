...
- Chapter 7: [Second-Order RLC Circuits](../../chapter7/index.md)
- Chapter 6: Transient Analysis RC/RL (from circuits textbook)
- RL Charging MicroSim - First-order RL counterpart (from circuits textbook)
- RC Charging MicroSim - First-order RC counterpart (from circuits textbook)
