...
Topics progress from number representations through Boolean algebra to systematic methods for designing and simplifying combinational logic circuits. Students will gain hands-on experience with truth tables, logic gates, Karnaugh maps, and canonical forms used in modern digital design.
...
- Judge when to use K-maps versus algebraic simplification
