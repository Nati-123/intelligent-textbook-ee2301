...
**Answer:** $F(A, B, C, D) = \prod M(0, 2, 4, 6, 8, 10, 12, 14)$
...
**Answer:** $F(A, B, C, D) = \sum m(1, 3, 5, 8, 9, 10, 11, 12, 14, 15)$
...
**Answer:** **Cofactor $F_0 = F|_{A=0}$:** Minterms with $A=0$: $m(0, 1, 4, 5, 6, 7)$ → as 3-variable function of $B, C, D$: $m_3(0, 1, 4, 5, 6, 7) = \overline{B} + C$
...
**Answer:** The maxterms present in $F$: $(A + B + C) = M_0$, $(A + \overline{B} + C) = M_2$, $(\overline{A} + B + \overline{C}) = M_5$
...
**Answer:** Since $F \cdot G = \sum m(1, 5, 7)$, $G$ must include minterms $1, 5, 7$.
