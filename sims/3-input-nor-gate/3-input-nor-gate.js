// 3-Input NOR Gate MicroSim
// Interactive 3-input NOR gate with truth table
...
function setup() {
  ...
  describe('Interactive 3-input NOR gate with clickable inputs and truth table', LABEL);
}
...
function draw() {
  ...
  textSize(13);
  textStyle(NORMAL);
  text('A 3-input NOR outputs 1 only when A = 0 AND B = 0 AND C = 0.', canvasWidth / 2, boxY + 12);
  text('For n inputs: output is 1 only when ALL n inputs are 0.', canvasWidth / 2, boxY + 28);
}
